 ...
 *
 * @property {object|string} definition - The Swagger definition location or structure. Only local `#/...` JSON
 * References are supported; external/relative references are rejected.
 * @property {object} [jsonRefs] - Options for local reference resolution
 * @property {boolean} [jsonRefs.resolveCirculars=false] - Whether to fully resolve circular `$ref`s. When `false`
 * (the default), circular references are left unresolved rather than dereferenced.
